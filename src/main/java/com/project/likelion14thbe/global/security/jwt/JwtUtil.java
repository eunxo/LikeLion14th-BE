...
public class JwtUtil {
    ...
    // 1. throws SignatureException 를 삭제합니다!
    public JwtDTO reissueToken(String refreshToken) {
        ...
        try {
            ...
            // 2. 여기서 발생한 예외를 RuntimeException 계열로 감싸서 던집니다.
            // 이러면 호출하는 쪽에서 throws를 안 써도 됩니다.
            throw new RuntimeException("토큰 재발급 중 서명 오류가 발생했습니다.", e);
        }
    }
