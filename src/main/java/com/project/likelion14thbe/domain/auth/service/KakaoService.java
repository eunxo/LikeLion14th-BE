...
public class KakaoService {
    ...
    public KakaoService(
            ...
            @Value("${spring.kakao.uri.redirect}") String redirectURI, MemberRepository memberRepository
    ) {
    ...
    public Optional<Member> findMember(KakaoUserInfoResponseDTO userInfo) {
        return memberRepository.findByEmailAndNotDeleted(userInfo.kakaoAccount().email());
    }
}