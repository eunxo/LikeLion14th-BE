package com.project.likelion14thbe.domain.kakao.controller;

import com.project.likelion14thbe.domain.kakao.dto.response.KakaoUserInfoResponseDTO;
import com.project.likelion14thbe.domain.kakao.service.KakaoService;
...
public class KakaoLoginController {
    ...
    public CustomResponse<JwtDTO> callback(
        ...
        JwtDTO jwtDTO = kakaoService.kakaoLoginOrSignup(userInfo);
